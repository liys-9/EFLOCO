...
class StepOptim(object):
    ...
    def alpha(self, t):
        # Call the scheduler and return alpha_t
    ...
    def inverse_lambda(self, lamb):
          # λ → t: exp -> SNR, then call snr_inverse
    ...
    def sel_lambdas_lof_obj(self, lambda_vec, eps):
        ...
        lambda_vec_ext = [lambda_eps] + lambda_vec + [lambda_T]  # Flow matching uses reversed time
    ...
    def get_ts_lambdas(self, N, eps, initType):
        ...
        if initType in ['unif', 'unif_origin']:
            ...
            t_vec = torch.linspace(eps, self.T, N + 1)  # From 0 → 1
            print(t_vec)
